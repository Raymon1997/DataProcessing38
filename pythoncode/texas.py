...
#     if header_dict['state'][i] == 'Texas':
#         if header_dict['city_or_county'][i] in county_dict:
#             county_dict[header_dict['city_or_county'][i]] += 1
#         else:
#             county_dict[header_dict['city_or_county'][i]] = 1
# print(county_dict)
...
#     try:
#         rate = county_dict[states[state_id]['name']]
#         idx = int(rate/70)
